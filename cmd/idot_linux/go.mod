...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/k8slogreceiver v0.136.0
	github.com/open-telemetry/opentelemetry-collector-contrib/receiver/k8sobjectsreceiver v0.136.0
